...
export const zhCN: Translations = {
  ...
  'plan.title': '实施计划',
  'plan.toggle': '计划模式',
  'plan.toggleTitle': '切换计划模式',
  'plan.showDiff': '显示差异',
  'plan.approve.button': '批准并执行',
  'plan.approve.currentSession': '在当前会话中执行',
  'plan.approve.newSession': '在新会话中执行',
  'plan.revise.button': '请求修改',
  'plan.revise.placeholder': '描述需要修改的内容...',
  'plan.revise.send': '发送',
  'plan.annotate.delete': '删除',
  'plan.annotate.insert': '插入',
  'plan.annotate.replace': '替换',
  'plan.annotate.comment': '评论',
  'plan.annotate.add': '添加',
  'plan.annotate.annotations': '标注',
  'plan.annotate.noAnnotations': '在计划中选择文本以添加标注',
  'plan.annotate.deleteConfirm': '标记为删除',
  'plan.annotate.commentPlaceholder': '添加评论...',
  'plan.annotate.insertPlaceholder': '输入要插入的文本...',
  'plan.annotate.replacePlaceholder': '输入替换文本...',
};
