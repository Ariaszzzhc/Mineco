...
import SidebarRow from "@/renderer/lib/ui/SidebarRow.svelte";
import AgentsView from "@/renderer/lib/components/settings/AgentsView.svelte";
import McpView from "@/renderer/lib/components/settings/McpView.svelte";
import SkillsView from "@/renderer/lib/components/settings/SkillsView.svelte";
import MemoryView from "@/renderer/lib/components/settings/MemoryView.svelte";
import AppearanceView from "@/renderer/lib/components/settings/AppearanceView.svelte";
